...
func (app *Config) listenForMail() {
	for {
		...
		case err := <-app.Mailer.ErrorChan: // in case of errors log and stop the goroutine
...
func (m *Mail) sendMail(msg Message, errorChan chan error) {
	...
	plaindMessage, err := m.buildPlainMessage(msg)
	if err != nil {
		errorChan <- err
	}
	...
	email.SetBody(mail.TextPlain, plaindMessage)
